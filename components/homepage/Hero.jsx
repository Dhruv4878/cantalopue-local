  ...
  return (
    <section className="relative w-full text-white overflow-hidden">
      ...
      >
        ...
        <div className="w-full lg:w-[55%] flex flex-col gap-3 text-left">
          {/* Top line */}
          <p
            className="
              hero-kicker
          ...
          <h1
            className="
              hero-heading
              text-[26px] sm:text-[32px] md:text-[36px] lg:text-[39px] xl:text-[44px]
          ...
          <p
            className="
              ...
              leading-[150%] md:leading-[140%] lg:leading-[120%]
            "
          >
