    ...
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden mt-20 px-4 text-white">
      ...
      <div
        className="
          ...
          bg-[#080819]/95
          px-8 py-10
          shadow-[0_0_45px_rgba(255,75,38,0.35)]
        "
      >
        ...
        <div className="relative space-y-7">
          ...
          <div className="space-y-2 text-center ">
            <h1 className="text-[30px] sm:text-[32px] font-bold leading-tight text-[#ff4b26]">
          ...
          <form onSubmit={handleSignupSubmit} className="space-y-5 text-sm">
            ...
            {/* error */}
            {error && (
              <p className="flex items-center justify-center rounded-md bg-red-900/30 px-3 py-2 text-xs text-red-300">
            ...
            <button
              ...
              className="
                ...
                rounded-xl bg-[#ff4b26]
                px-4 py-2.5 text-sm font-semibold text-white
                shadow-[0_0_30px_rgba(255,75,38,0.6)]
                hover:bg-[#ff5b36] active:scale-[0.99]
