    ...
    >
          ...
          <div className="lg:pr-8">
            ...
            <div className="space-y-4 sm:space-y-6">
              <ContactDetailCard
                ...
                content="hello@cantaloupe.ai"
                isLink
                linkHref="mailto:hello@cantaloupe.ai"
              />
              <ContactDetailCard
                icon={Briefcase}
                title="Sales & Partnership"
                content="sales@cantaloupe.ai"
                isLink
                linkHref="mailto:sales@cantaloupe.ai"
              />
              <ContactDetailCard
                icon={Phone}
      ...
      <div className="mt-16 sm:mt-20 pt-8 border-t border-white/10 text-center text-white/50">
        <p className="text-[11px] sm:text-sm">
          &copy; {new Date().getFullYear()} Cantaloupe.AI. All rights reserved. | The
