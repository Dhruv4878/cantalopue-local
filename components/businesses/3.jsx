...
const DefineBrandForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const profileData = {
      ...
      businessLogo: step3Data.businessLogo || step3Data.logoUrl || logoUrl || "",
      brandTone: step3Data.brandTone || brandTone || "",
      primaryBrandColor: step3Data.primaryBrandColor || "",
      secondaryBrandColor: step3Data.secondaryBrandColor || "",
      targetAudience: step3Data.targetAudience || "",
      keyMessages: step3Data.keyMessages || "",
      contentThemes: step3Data.contentThemes || "",
      postingFrequency: step3Data.postingFrequency || "",
      timezone: step3Data.timezone || "",
    };
  ...
  return (
    <div className="relative min-h-screen bg-brand-dark text-white font-poppins overflow-hidden">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-14">
        {/* HEADER — unchanged */}
