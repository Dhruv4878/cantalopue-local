              ...
              {sections.map(({ id, label, icon: Icon }) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2 px-3 py-2 rounded-xl text-xs sm:text-sm whitespace-nowrap transition ${
                      active
                        ? "bg-white/15 text-white shadow-[0_0_12px_rgba(255,140,0,0.45)]"
