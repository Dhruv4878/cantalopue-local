...
const mockData = {
  ...
  engagementRate: 7.2,
  connectedPlatforms: [
    { name: "Facebook", icon: Facebook, color: "#4267B2", status: "Active" },
    { name: "Instagram", icon: Instagram, color: "#E1306C", status: "Active" },
    { name: "Twitter", icon: Twitter, color: "#1DA1F2", status: "Inactive" },
    { name: "LinkedIn", icon: Linkedin, color: "#0077B5", status: "Active" },
  ],
  ...
  return (
    <div className="p-3 sm:p-4 lg:p-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 lg:mb-8">
        ...
        />
        <StatBlock
          title="Subscription Usage Cost"
          value={`$${
            dashboardData.paymentGraph[dashboardData.paymentGraph.length - 1]
              .value
          }`}
          icon={DollarSign}
          color="#FF5252"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="lg:col-span-1 min-w-0">
          <GlassCard className="h-auto md:h-48 flex flex-col">
            <h3 className="text-lg sm:text-xl font-bold mb-4 border-b border-white/10 pb-2">
              AI Content Insight
            </h3>
