...
/* ---------- Shared UI Components (from new UI) ---------- */
...
const GenerateAIContent = () => {
  ...
  /* ---------- Helpers copied from older UI (JS only) ---------- */
  ...
  /* ---------- Load brief & platforms from sessionStorage ---------- */
  ...
  /* ---------- Load history from DB (same logic as older UI) ---------- */
  ...
  const handleGenerateContent = async (e) => {
    ...
    try {
      ...
      // Save text-only draft and redirect to dedicated editor page
  ...
  /* ---------- UI: new glass layout, old content flow ---------- */

  return (
    <div className="min-h-screen bg-[#050816] text-white p-4 lg:p-8">
                  ...
                  >
                    <div className="pr-2">
                      <h3 className="font-medium text-sm text-white mb-1 line-clamp-2">
                        {(h.content?.postContent || "Generated Post").slice(
                          0,
                          80
                        )}
                      </h3>
